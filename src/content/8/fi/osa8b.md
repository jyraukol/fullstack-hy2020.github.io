...
Hookin toisena parametrina, eli hookin suorittamisen riippuvuutena, on _result_. Tämä saa aikaan sen, että hookin ensimmäisenä parametrina oleva funktio suoritetaan <i>aina kun kyselyn palauttama result muuttuu</i>. Lisäksi tarkistamme, että resultin kenttä data ei ole undefined ennen haetun henkilön tietojen asettamista komponentin tilaan. Jos päivitystä ei hoidettaisi kontrolloidusti hookissa, seuraisi ongelmia sen jälkeen kun yksittäisen henkilön näkymästä palataan kaikkien henkilöiden näkymään.
